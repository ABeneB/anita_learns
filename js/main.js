var App = {
	...
	Website : {
		...
		init_exc : function() {
			...
			//Erstellt Knopf für sound
			function sound_button(word) {
				$(".mid").append("<br><button type='button' id='sound' class='btn btn-default btn-lg'>Sound-Beispiel</button>");
				$('#sound').on("click", function() {
					$.playSound('sounds/' + word.sound);
					// FIXME - funzt net
				});
